function estraiTotale(data,anni,colonna, sesso = 'Maschi'){
  let dataset = null;
  let somma = 0;
  let container = {};
  anni.forEach(
...
function calcoloWi(data,anni){
  let container = estraiTotale(data,anni,'peso_classe');
  let dataset = [];
  let div = 0;
  let obj = {};
  anni.forEach(
...
function tassoStandard(data,anni,k = 1000, sesso = 'Maschi'){
  let dataset = null;
  let wi = calcoloWi(data,anni);
  let ti = 0;
  let sommatoria = {
    numeratore: 0,
    denominatore: 0
...
function tassoGrezzo(data,anni,k = 1000, sesso = 'Maschi') {
  let casi = estraiTotale(data,anni,'casi', sesso);
  let popolazione = estraiTotale(data,anni,'popolazione', sesso);
  let tasso = {};
  anni.forEach( el => {
...
function intervalloTg(data,anni,sesso = 'Maschi') {
  let tassi = tassoGrezzo(data,anni,1, sesso);
  let popolazione = estraiTotale(data,anni,'popolazione', sesso);
  let sqrt = 0;
  let container = {};
  let obj = {};
...
function calcoloEsLogTs(data,anni,sesso = 'Maschi'){
  let dataset = null;
  let wi = calcoloWi(data,anni);
  let tassi = tassoStandard(data,anni,1, sesso);
  let sommatoria = 0;
  let es = {};
  let valore = 0;
  anni.forEach(
...
function intervalloTs(data,anni,sesso = 'Maschi') {
  let tassi = tassoStandard(data,anni,1, sesso);
  let esLog = calcoloEsLogTs(data,anni,sesso);
  let container = {};
  let valore = 0;
  let obj = {};
  anni.forEach( el => {
