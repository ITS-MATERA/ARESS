function raggruppaClassiTrendEta(dataset) {
  ...
  function estraiTotaleClassiTrendEta(colonna, dataset, anni, gruppoEta) {
    let datatemp = null;
    let dataRif = null;
    let somma = 0;
    let container = {};
    let riferimenti = estraiFiltroTrendEta("riferimento", dataset);
  ...
  function calcoloWiClassiTrendEta(dataset, anni, gruppoEta, classiEta) {
    let totale = estraiTotaleClassiTrendEta("peso_classe", dataset, anni, gruppoEta);
    let container = {};
    let datatemp = [];
    let div = 0;
    let valore = {};
  ...
  function tassoStandardClassiTrendEta(dataset, anni, gruppoEta, classiEta, k = 1000) {
    let datatemp = null;
    let wi = calcoloWiClassiTrendEta(dataset, anni, gruppoEta, classiEta);
    let ti = 0;
    let sommatoria = {
      numeratore: 0,
      denominatore: 0,
  ...
  function tassoGrezzoClassiTrendEta(dataset, anni, gruppoEta, k = 1000) {
    let casi = estraiTotaleClassiTrendEta("casi", dataset, anni, gruppoEta);
    let popolazione = estraiTotaleClassiTrendEta("popolazione", dataset, anni, gruppoEta);
    let tasso = {};
    anni.forEach((anno) => {
      tasso[anno] = {};
      gruppoEta.forEach((el) => {
  ...
  function intervalloTgTrendEta(dataset, anni, gruppoEta) {
    let tassi = tassoGrezzoClassiTrendEta(dataset, anni, gruppoEta, 1);
    let popolazione = estraiTotaleClassiTrendEta("popolazione", dataset, anni, gruppoEta);
    let sqrt = 0;
    let container = {};
    let obj = {};
  ...
  function calcoloEsLogTsTrendEta(dataset, anni, gruppoEta, classiEta) {
    let datatemp = null;
    let wi = calcoloWiClassiTrendEta(dataset, anni, gruppoEta, classiEta);
    let tassi = tassoStandardClassiTrendEta(dataset, anni, gruppoEta, classiEta, 1);
    let sommatoria = 0;
    let es = {};
    let valore = 0;
    anni.forEach((el) => {
  ...
  function intervalloTsTrendEta(dataset, anni, gruppoEta, classiEta) {
    let tassi = tassoStandardClassiTrendEta(dataset, anni, gruppoEta, classiEta, 1);
    let esLog = calcoloEsLogTsTrendEta(dataset, anni, gruppoEta, classiEta);
    let container = {};
    let valore = 0;
    let obj = {};
    anni.forEach((el) => {
  ...
  const estraiFiltroTrendEta = (column, dataset) => {
